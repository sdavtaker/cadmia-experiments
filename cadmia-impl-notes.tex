...
\title{CadmIA --- IA-DEVS Implementation Notes\\
  \large Assumptions and Constraints Common to All Experiments}
...
This document records the design decisions and invariants of the CadmIA
...
% ─────────────────────────────────────────────────────────────────────────────
\section*{Outward-Rounding Invariant}
...
\subsection*{Consequences by TIME type}
