...
CadmIA does not yet implement a typed port system.  Components are connected
by a single untyped channel per pair; the message \emph{value} distinguishes
signal semantics.  Each experiment spec must document the value-to-signal
encoding it uses.
