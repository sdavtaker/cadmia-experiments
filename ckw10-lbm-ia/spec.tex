  ...
  \item \textbf{UA-DEVS $\to$ IA-DEVS.}
        ...
        \begin{itemize}
          \item LG and servers: the UA-DEVS set $(0,+\infty)$ is
            ...
            This is a valid IA-DEVS interval and produces the bound
            $P_{\mathrm{loss}} \in [0,1]$.  Choosing a tighter interval
            such as $[\sigma_L, \sigma_U]$ is a further modelling decision
            that restricts which trajectories are included and yields more
            informative bounds.
